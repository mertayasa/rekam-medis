 ...
 *   https://datatables.net/download/#bs5/dt-1.11.5/fc-4.0.2/fh-3.2.2/r-2.2.9/sb-1.3.2
 *
 * Included libraries:
 *   DataTables 1.11.5, FixedColumns 4.0.2, FixedHeader 3.2.2, Responsive 2.2.9, SearchBuilder 1.3.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.models.oSearch = {
		...
		DataTable.ext = _ext = {
			 ...
			 *  @type string
			 */
			build:"bs5/dt-1.11.5/fc-4.0.2/fh-3.2.2/r-2.2.9/sb-1.3.2",
