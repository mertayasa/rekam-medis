                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-2  pb-3 pb-3">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="rasa_nyeri" id="rasa_nyeri1" value="mengekuh_nyeri" x-model="$store.rmedis.data.rasa_nyeri">
                            <label class="form-check-label" for="rasa_nyeri1">
                                Pasien mengekuh nyeri
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="rasa_nyeri" id="rasa_nyeri2" value="nyeri_berkurang" x-model="$store.rmedis.data.rasa_nyeri">
                            <label class="form-check-label" for="rasa_nyeri2">
                                Pasien nyeri berkurang
                            </label>
                          </div>
                          <div class="form-check">
                            <input class="form-check-input" type="radio" name="rasa_nyeri" id="rasa_nyeri2" value="tidak_nyeri" x-model="$store.rmedis.data.rasa_nyeri">
                            <label class="form-check-label" for="rasa_nyeri2">
